    ...
    public class EdgePipe : PipeData
    {
        ...
        public override void Output()
        {
            ...
            for (int i = 0; i < normals.Length; i++)
                normals[i] = (points[i + 1] - points[i]).Rotate_90().normalized;
            ...
            Vector2 GetWidth(Vector2 p, Vector2 normal_A, Vector2 normal_B)
            {
                ...
                Vector2 widthPoint = Math_Utility.GetLineIntersection(a, a + normal_A.Rotate_90(), b, b + normal_B.Rotate_90(), out bool parallel);
            ...
            {
                Vector2 a = p + normal_A * width;
                Vector2 widthPoint = Math_Utility.GetLineIntersection(p, p + line, a, a + normal_A.Rotate_90(), out bool parallel);
                return (parallel? a : widthPoint) - p;
            }
        }
    }
