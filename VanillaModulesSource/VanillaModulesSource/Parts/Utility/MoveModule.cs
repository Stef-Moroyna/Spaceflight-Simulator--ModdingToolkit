...
namespace SFS.Parts.Modules
{
                ...
                switch (a.type)
                {
                    ...
                    case MoveData.Type.Active:
                        ...
                        if (audioSource && Application.isPlaying)
                            audioSource.volume = Audio.AudioSettings.main.soundVolume * valueAtTime;
                        break;
                    ...
                    case MoveData.Type.SoundVolume:
                        if (Application.isPlaying)
                            a.audioSource.volume = Audio.AudioSettings.main.soundVolume * a.X.Evaluate(time.Value - a.offset);
                        break;
    ...
    public class MoveData
    {
        ...
        [ShowIf("ShowImage"), Required] public Image image;
